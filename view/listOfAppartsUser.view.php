...
?>
<div class="container">
    <div class="spaceTopAppart">
        <h1> Mon appartement</h1>
        <button><a href="../welcome.php"> Voir mon profil </a></button>
        <button><a href="../controller/insertAppart.php" style="text-decoration: none; color: black" id="ajoutLogement">Ajouter un nouveau
                logement</a></button>
        <button><a href="../controller/updateAppart.php" style="text-decoration: none; color: black">Modifier les
                informations sur mon logement</a></button>
        <button><a href="../controller/deleteAppart.php" style="text-decoration: none; color: black">Supprimer mon
                logement</a></button>
    </div>
</div>
